...
FAL_MODSTR( inotify_msg_1, "Falcon bindings to inotify" );

//... add here your messages, and remove or configure the above one

// /*
//  *  messages for inotify errors (one by error id)
//  *  add a trailing underscore to avoid names collision
//  */
// FAL_MODSTR( inotify_e_abstract_class_,      "unable to create instance of abstract class" );
// FAL_MODSTR( inotify_e_init_failure_,        "init function failure" );
//
// /*
//  *  messages for param errors
//  */
// FAL_MODSTR( inotify_e_require_no_args_,     "this method does not accept arguments" );
// FAL_MODSTR( inotify_e_inv_window_type_,     "invalid window type" );
// FAL_MODSTR( inotify_e_inv_property_,        "invalid object property" );
